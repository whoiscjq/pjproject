...
turn_num=3
output_file="SC_prp/data/tmp_first_output.jsonl"
...
for message in data:
    for _ in range(turn_num):
        questions.append([{"role":"system","content": "After generating the answer, you should add '##answer:' and the final numerical answer at the end (digit only)"},{"role": "user", "content":gen_prompt(message["question"])}])
